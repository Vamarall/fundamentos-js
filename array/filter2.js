...
console.log(produtos.meuFilter(p => p.preco > 1000))

// Filtrando produtos que não são frágeis e com preço menor que 300
console.log(produtos.meuFilter(p => p.fragil === false).meuFilter(p => p.preco < 300))
...
// Encadeando filtros
console.log(produtos.meuFilter(fragil).meuFilter(menorQue300));